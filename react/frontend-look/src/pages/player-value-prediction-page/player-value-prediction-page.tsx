...
import styles from './player-value-prediction-page.module.scss';

export interface PlayerValuePredictionPageProps {
    className?: string;
}

export const PlayerValuePredictionPage: React.FC<PlayerValuePredictionPageProps> = ({
    className = '',
}) => (
    <div className={className}>
        PlayerValuePredictionPage
        <br />
        <img
            src="https://wixplosives.github.io/codux-assets-storage/add-panel/image-placeholder.jpg"
            className={styles['plyer-img']}
        />
        <br />
        TextParagraphs are the building blocks of papers. Many students define paragraphs in terms
        ...
        this handout, we will refer to this as the “controlling idea,” because it controls what
        happens in the rest of the paragraph.
        <br />
        <button className={styles.button_cal_value}>
